...
void Traffic_Stats::finish()
{
    ...
    out<<"  <CHECK-SUM> "<<  sizeHistogram->calculateCheckSum() << " </CHECK-SUM>"<<endl;// for checking TODO REMOVE!!!!
    out<<"  <OVERFLOW-PACKETS> "<< sizeHistogram->getOverflowPackets() <<" </OVERFLOW-PACKETS>"<<endl;
    out<<"  <UNDERFLOW-PACKETS> "<< sizeHistogram->getUnderflowPackets() <<" </UNDERFLOW-PACKETS>"<<endl;
