...
class ONOFF_Parameters_Calculator : public cSimpleModule
{
  protected:
...
Define_Module(ONOFF_Parameters_Calculator);


#define gDEBP(A,B) (A->getDocumentElementByPath(A,B))->getNodeValue()


void ONOFF_Parameters_Calculator::initialize()
{
...
void ONOFF_Parameters_Calculator::handleMessage(cMessage *msg)
{
...
double ONOFF_Parameters_Calculator::amotry2d(double F[3], double X[3], double Y[3],
                double c)
{
...
double ONOFF_Parameters_Calculator::amoeba2D(double F[3],double X[3], double Y[3],
                               double ftol,int *nfunk )
{
...
void ONOFF_Parameters_Calculator::Dconv(double* v1, int size1, 
                                        double* v2, int size2, 
                                        double* r )
{
    int i, j, k;
...
double* ONOFF_Parameters_Calculator::ONOFFsrcProb(int N)
{
...
double ONOFF_Parameters_Calculator::getSleepParameter(double Eoff)
{
    if(Eoff<0) { 
...
double ONOFF_Parameters_Calculator::R(double tau, double x, double y)
{
	int i, imax, k, n, m;
...
#define FIT_POINTS 5	//EARLY WAS  5

double ONOFF_Parameters_Calculator::differ(double x, double y)
{
	int k;
